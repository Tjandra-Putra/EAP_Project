...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <main>
        <div class="container justify-content-center">
            <div class="container">
                <asp:GridView ID="gvViewDetails" runat="server" AutoGenerateColumns="False" CssClass="table shadow table-light border-0 table-condensed table-responsive table-hover mb-5">
                    <HeaderStyle
                        BackColor="#606060"
                        Height="35"
                        ForeColor="White"
